"""
Django settings for ptu8_handmade_watercolors project.
...
ROOT_URLCONF = 'ptu8_handmade_watercolors.urls'
...
WSGI_APPLICATION = 'ptu8_handmade_watercolors.wsgi.application'
